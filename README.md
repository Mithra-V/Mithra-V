...
### 🔹 Ubuntu Virtual Machine on Azure with GUI Access (RDP)
Deployed an Ubuntu Virtual Machine on Microsoft Azure with secure terminal access and GUI-based access using Remote Desktop Protocol (RDP).
